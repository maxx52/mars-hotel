		...
		<v-container>
			<v-row>
				<div class="mr-auto ml-auto contact">
					...
					<iframe src="https://yandex.ru/sprav/widget/rating-badge/145952256912?type=rating" class="ml-auto mr-auto d-block mt-16" width="350" height="150" frameborder="0"></iframe>
				</div>
			</v-row>
		</v-container>
	</section>
