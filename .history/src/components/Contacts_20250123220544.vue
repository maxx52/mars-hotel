<template>
	<section class="sect_contacts" id="contacts" style="background-color: #EFDFD2;">
		<v-container>
			<v-row>
				<div class="mr-auto ml-auto contact">
					...
					<iframe src="https://yandex.ru/sprav/widget/rating-badge/145952256912?type=rating" class="ml-auto mr-auto d-block mt-16" width="150" height="50" frameborder="0"></iframe>
				</div>
			</v-row>
		</v-container>
	</section>
