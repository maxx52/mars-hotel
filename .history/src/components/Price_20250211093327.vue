...
export default {
	data: () => ({
        ...
        subtitle: 'Погрузитесь в атмосферу элегантности. Дизайнерское оформление сочетает в себе современный стиль и уют, создавая идеальную обстановку для вашего отдыха.', text: 'от 2390 руб.', link: '/hotel' },
			{ title: 'Забронировать апартаменты', subtitle: 'Современное оформление и уютная атмосфера, идеально подходящая как для краткосрочного, так и для длительного проживания', text: 'от 2190 руб.', link: 'apartments' },
