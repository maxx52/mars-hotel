      ...
      <v-row>
        <v-col md="6" xs="12" sm="6" v-for="(card, i) of cards" :key="i">
          <v-card variant="outlined" class="text-center pa-4 pa-sm-5 bg-white" elevation="15" min-height="420">
            <v-carousel height="300" hide-delimiter-background hide-delimiters cycle
              interval="8000" class="relative">
            ...
            <v-card-text class="text-md-h3 text-sm-h4 text-h4 text-lg-h2 font-weight-bold">{{ card.text
              }}</v-card-text>
            <v-card-actions>
              <section class="buttons">
                <div class="container">

                  <a :href="card.link" class="btn btn-1">
                    <svg>
...
export default {
  data: () => ({
    cards: [
      {
        title: 'Двухместный стандартный улучшенный номер с одной кроватью (1)',
        ...
        slides: [
          {
            src: require('../../hotel-1/main.jpg'),
            src: require('../../hotel-1/1.jpg'),
            src: require('../../hotel-1/2.jpg'),
            src: require('../../hotel-1/3.jpg'),
            src: require('../../hotel-1/4.jpg'),
            src: require('../../hotel-1/5.jpg'),
            src: require('../../hotel-1/6.jpg'),
            src: require('../../hotel-1/7.jpg'),
            src: require('../../hotel-1/8.jpg'),
            src: require('../../hotel-1/9.jpg'),
            src: require('../../hotel-1/10.jpg'),
            src: require('../../hotel-1/11.jpg'),
            src: require('../../hotel-1/12.jpg'),
            src: require('../../hotel-1/13.jpg'),
            src: require('../../hotel-1/14.jpg'),
            src: require('../../hotel-1/15.jpg'),
            src: require('../../hotel-1/16.jpg'),
            src: require('../../hotel-1/17.jpg'),
            src: require('../../hotel-1/18.jpg'),
            src: require('../../hotel-1/19.jpg'),
            src: require('../../hotel-1/20.jpg'),
            src: require('../../hotel-1/21.jpg'),
            src: require('../../hotel-1/22.jpg'),
            src: require('../../hotel-1/23.jpg'),
            src: require('../../hotel-1/24.jpg'),
          }
        ]
      },
      {
