      ...
      <v-row>
        <v-col md="6" xs="12" sm="6" v-for="(card, i) of cards" :key="i">
          <v-card variant="outlined" class="text-center pa-4 pa-sm-5 bg-white" elevation="15" min-height="420">
            ...
            <v-card-actions>
              <v-col class="relative d-flex" no-gutters>
                <v-col md="2">
                  <v-img src="../../assets/imen.png" width="50"></v-img>
                </v-col>
                <v-col md="5">
                  <v-card-text class="text-md-h3 text-sm-h4 text-h4 text-lg-h4">{{ card.text }}</v-card-text>
                </v-col>
                <v-col md="4">
                  <v-btn href="https://api.whatsapp.com/send/?phone=79095066777&text&type=phone_number&app_absent=0"
                    class="ml-auto mr-auto text-white pa-3 pa-sm-3 pa-md-3 pb-7 mb-5 bg-custom" width="100%">Забронировать</v-btn>
                </v-col>
              </v-col>
