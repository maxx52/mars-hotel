      ...
      <v-row>
        <v-col md="6" xs="12" sm="6" v-for="(card, i) of cards" :key="i">
          <v-card variant="outlined" class="text-center pa-4 pa-sm-5 bg-white" elevation="15" min-height="420">
            ...
            <v-card-actions>
              <v-btn href="https://api.whatsapp.com/send/?phone=79095066777&text&type=phone_number&app_absent=0" class="ml-auto mr-auto text-white pa-3 pa-sm-3 pa-md-3 pb-7 mb-5 bg-custom">Забронировать</v-btn>
            </v-card-actions>
          </v-card>
        </v-col>
      </v-row>
