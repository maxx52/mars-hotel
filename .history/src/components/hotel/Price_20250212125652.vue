...
export default {
  data: () => ({
    cards: [
      ...
      { title: 'Двухместный стандартный улучшенный номер с двумя кроватями', subtitle: 'Уютные пространства идеально подходят для тех, кто ищет доступное и удобное жилье на время отдыха или командировки. Оснащенные необходимой мебелью и бытовой техникой, апартаменты обеспечивают все условия для комфортного проживания.', text: 'от 2190 руб.' },
