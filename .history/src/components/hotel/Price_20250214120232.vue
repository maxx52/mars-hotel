      ...
      <v-row>
        <v-col md="6" xs="12" sm="6" v-for="(card, i) of cards" :key="i">
          <v-card variant="outlined" class="text-center pa-4 pa-sm-5 bg-white" elevation="15" min-height="420">
            ...
            <v-card-actions>
              <v-col class="relative d-flex flex-md-grow-1" no-gutters>
                ...
                <v-col md="5">
                  <v-card-text class="text-md-h3 text-center ml-5 text-sm-h4 text-h4 text-lg-h5">{{ card.text }}</v-card-text>
                </v-col>
                <v-col md="4">
