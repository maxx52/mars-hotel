        ...
        <v-col md="6" xs="12" sm="6" v-for="(card, i) of cards" :key="i">
          <v-card variant="outlined" class="text-center pa-4 pa-sm-0 bg-white" elevation="15" min-height="420">
            ...
            <v-card-actions class="pa-0">
              <v-col class="relative d-flex flex-md-grow-1 pa-0" no-gutters>
                <v-col md="2" sm="2" class="d-flex flex-md-grow-1 pa-sm-0">
                  <v-img src="../../assets/imen.png" width="20"></v-img>
                  <span class="text-h4 mt-3 mt-md-8 text-md-h5 font-weight-thin">/</span>
                  <v-img src="../../assets/imen.png" width="20"></v-img>
                  <v-img src="../../assets/imen.png" width="20"></v-img>
                </v-col>
                <v-col md="5" sm="6" class="pa-0">
                  <v-card-text class="text-md-h5 pa-0 mb-sm-0 text-center ml-3 text-sm-h5 text-h4 text-lg-h5">{{ card.text }}</v-card-text>
                </v-col>
