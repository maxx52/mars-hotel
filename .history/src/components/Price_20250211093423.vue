...
export default {
	data: () => ({
        ...
        subtitle: 'Современное оформление и уютная атмосфера, идеально подходящая как для краткосрочного, так и для длительного проживания', text: 'от 2190 руб.', link: 'apartments' },
