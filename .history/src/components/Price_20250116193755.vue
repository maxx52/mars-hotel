<template>
	<section class="sect-price pt-10 pb-10" id="price" style="background-color: #EFDFD2;">
		<v-container>
			<v-row>
				...
				<v-col md="6" xs="12" sm="6" v-for="(card, i) of cards" :key="i">
					<v-card variant="outlined" class="text-center pa-4 pa-sm-5" elevation="15" min-height="420">
